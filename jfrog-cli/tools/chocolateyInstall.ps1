...
$packageArgs = @{
  ...
  fileType               = 'EXE'
  url64bit               = 'https://dl.bintray.com/jfrog/jfrog-cli-go/1.37.1/jfrog-cli-windows-amd64/jfrog.exe'
  checksum64             = 'f33097165cd7152fe06d93a1ddccd71a26b5c98a2035260d1f117cec4104d550'
